...
<title>Служба поддержки OLD-BK.com - support</title>
...
<div class="langSelect">	<ul>	<li>
		<a href="javascript:setCurrentLang('en')" >English</a>
	</li>	<li>
		<a href="/support.php" style="color: white; font-weight: bold">Русский</a>
	</li>	</ul>
</div>
	<table border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#f8f1d4" width="80%">
		...
		<table border="0" cellpadding="0" cellspacing="0" width=100%>
			<tr bgcolor="#242422">
				<td valign="bottom"><a href="/support.php"><img src="/img/support/logo.gif" width="416" height="140" alt="Support" border="0"></a></td>
...
<tr>
	...
	<td colspan=2>
<center><h3>Support Center <br><span style="color: #ff0000;">[test mode]</span></h3></center>
...
<center><h5>Create new topic</h5></center>
Please describe your situation in this form.<br>
...
<form method="post" onSubmit="return checkForm(this);">
	<input type="hidden" name="action" value="send_feedback" />
		<table border="0" cellpadding="2" cellspacing="0">
			...
			<tr>
				<td align="right">Character: &nbsp;</td><td><b><?=$p['login']?></b></td>
			</tr>
<!--			<tr>
...
-->			
			<tr>
				<td align="right">Category: &nbsp;<sup style="color:red">*</sup></td><td><select name="message_type" class="input">
					<option style="color: #ff0000;" value="1001">Common</option>
					<option  value="11">&nbsp;&nbsp;&nbsp;&nbsp;Character evolution</option>
					...
					<option style="color: #ff0000;" value="1003">'Game errors</option>
					<option  value="31">&nbsp;&nbsp;&nbsp;&nbsp;Грамматика и пунктуация</option>
					<option  value="32">&nbsp;&nbsp;&nbsp;&nbsp;Fight system</option>
					<option  value="33">&nbsp;&nbsp;&nbsp;&nbsp;Inventory</option>
					<option  value="34">&nbsp;&nbsp;&nbsp;&nbsp;Излом хаоса</option>
					<option  value="35">&nbsp;&nbsp;&nbsp;&nbsp;Interface</option>
					<option  value="36">&nbsp;&nbsp;&nbsp;&nbsp;Quests</option>
					<option  value="37">&nbsp;&nbsp;&nbsp;&nbsp;Shops</option>
					<option  value="38">&nbsp;&nbsp;&nbsp;&nbsp;Magic system</option>
					<option  value="39">&nbsp;&nbsp;&nbsp;&nbsp;Moderation</option>
					<option  value="310">&nbsp;&nbsp;&nbsp;&nbsp;Обменник</option>
					<option  value="311">&nbsp;&nbsp;&nbsp;&nbsp;Dungeons</option>
					<option  value="312">&nbsp;&nbsp;&nbsp;&nbsp;Chat system</option>
					<option  value="313">&nbsp;&nbsp;&nbsp;&nbsp;Случайные или/и трудновоспроизводимые баги</option>
					<option  value="314">&nbsp;&nbsp;&nbsp;&nbsp;Other errors</option>
			...
			<tr>
				<td align="right">Subject: &nbsp;<sup style="color:red">*</sup></td><td><input type="text" name="message_subject" value="" class="input" size="80" maxlength="100" /></td>
			</tr>
 
			<tr>

			<td valign="top" align="right">Message: &nbsp;<sup style="color:red">*</sup></td><td><textarea name="message" cols="81" rows="15" class="input" maxlength="3000"  onkeyup="ismaxlength(this)"  onmousedown="ismaxlength(this)" style="width:600px; height: 200px;" onselect="ismaxlength(this)"></textarea></td>
			</tr>
			<tr>
				<td valign="top"></td><td align="ridght"><input type="submit" value="Send message" class="input" /></td>
			</tr>
		</table>
	</form>
<!-- feedback form -->
...
$headers  = "Mime-Version: 1.1 \r\n";
		...
		$headers .= "From: ".$p['login']." <support@cruel-world.ru>\r\n";
		...
		//mail("support@cruel-world.ru","тема",$aa,$headers);
		mail("support@cruel-world.ru","",$aa,$headers);

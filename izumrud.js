...
function VesualBot(bots,loc)
{
	...
	{
		cord+=40;
		k+= "<img src='img/izumrud/bots/"+bots[i]+".gif' style='POSITION:absolute;LEFT:"+cord+"px;' title='Подземные существа'>";
	}
...
function VesualBot2(bots,loc)
{
	...
	{
		cord+=35;
		k+= "<img src='img/izumrud/bots/"+bots[i]+".gif' style='WIDTH:70px;POSITION:absolute; LEFT:"+cord+"px;' title='Подземные существа'>";
	}

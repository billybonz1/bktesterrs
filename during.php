...
<?
	...
	while($res=mysql_fetch_array($battle))
	{
		...
		echo "<tr class='".($n?'l0':'l1')."'><td nowrap valign=top>".$vaxt."<br><small><b>Тип боя:</b> <u>".boy_type($battle_type)."</small></td><td width=100%> $team1 против $team2 &nbsp; &nbsp;$battle_img <a href='log.php?log=".$bid."' class=us2>»»</a></td></tr>";
	}

...
if($db["battle"] && $db["hp"] && $db["battle_opponent"]!="")
{
	...
	if($hp_now<$hp_all)
	{
		...
		$phrase="<span class=date>$date</span> <span class=$span>".$login."</span> понимая, что ситуация становится критической, применил прием <b>Лечение</b> и восстановил свое здоровье <span class=hitted>+$hp_add</span> [$hp_new/$hp_all]<BR>";
		$bid=$db["battle"];

...
if($_POST['target'] && $kupon_count>0)
{
	...
	{	
		...
		{
			mysql_query("INSERT INTO inv (owner, object_id, object_type, object_razdel, msg, gift, gift_author, term) VALUES ('".$res['login']."', '".$object_id."', 'flower', 'other', 'Вы являетесь Участником Джекпота', 1, 'UFC', '".(time()+3600*24*30)."')");

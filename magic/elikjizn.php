...
else 
{
	...
	if($hp_all - $hp_now==0)
	{
		$_SESSION["message"]="Вы и так здоровы.";
	}
	else 
	{
		...
		$_SESSION["message"]="Вы удачно прокастовали заклинание <b>&laquo;".$name."&raquo;</b> и восстановили свое здоровье на <b>$hp_add HP</b>!";
		drop($spell,$DATA);
	}
}

...
<?
print"<font style='font-size:14px; color:#990000';><center>Спасибо за регистрацию!<br>
Пройдите на главную сраницу <a href='/' target=_blank>Королевство Грез</a> и <br>
введите логин и пороль для входа!</center></font>";
die();
?>
</BODY>
<?
		...
		<td>
			...
			<table  border="0" cellspacing="0" cellpadding="0">
				...
				<table><tr><td><A href="" 
                        target=_blank><IMG 
                        src="img/vk.png" 
                        width=150 border="0"></A>--></td></tr>	</table>
				...
				<tr valign="top">
					<td colspan="2" width="620" background="img/first/my-1_17.png" >
						...
						<span class="news">
						<table align="left" width="565" height="550" cellspacing="2" cellpadding="2">
						 <tr><td align="left" valign="top">
							<div align="center"><font color="#804040"><h3>Регистрация!</h3></font></div>
					
							<hr>

                      </iframe> frameborder=0 src="<?=$sait?>/reg.php?ref=<?=$_GET['ref']?>" width="100%" height="80%" /iframe>
<? include'reg.php';?>
				</td></tr>
					</table>	
						</span>

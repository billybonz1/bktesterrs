...
<tr>
    ...
    <td align=\"center\" valign=\"center\" width=100%>
		...
		switch ($level)
		{
						...
						<td>
				            ...
				            <tr>
				                ...
				                <TD colspan=\"2\">
				                    ...
				                    <LABEL for=A3><font color=#FF0000>*</font> Я обязуюсь соблюдать</LABEL> <A TARGET=\"_blank\" HREF=\"rules.php\"><B>Законы UFC</B></A> и согласен со всеми пунктами <A TARGET=\"_blank\" HREF=\"soqlaweniya.php\"><B>Пользовательского соглашения</B></A>
				            	</td>
							</tr>
							<tr>
			...
			При входе в портал Вы принимаете <A TARGET=_blank href=\"rules.php\"><u>Законы и Соглашение UFC </u></a>
			<br><br>&copy; Copyright 2006-".date("Y").",все права защищены. <a href=''class=us2>UFC/a>
			</td></tr></table>";
	echo "</td>

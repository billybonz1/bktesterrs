function getalign(align)
{
	...
	if (n == 10) return("Рекламный Отдел");
	if (n == 99) return("Драконы");
...
function drbt(name, dealer, align, rang, klan,  klanid, hp, hpall, class_name,is_hit)
{
	...
	s+=" <a href='http://UFC/info.php?log="+for_info+"' target='_blank'><img src='http://UFC/img/index/h.gif' alt='Инф. о "+for_info+"' border='0' /></a> ";
	s+="["+hp+"/"+hpall+"]";
	document.write(s);
}
...
function lrb(name, level, dealer, align, rang, klan,  klanid, class_name)
{
	...
	s+=" <a href='http://UFC/info.php?log="+name+"' target='_blank'><img src='http://UFC/img/index/h.gif' alt='Инф. о "+name+"' border='0' /></a>";
	document.write(s);
}
...
{
	var s="";
	if (align>0) s+="<img src='http://UFC/img/orden/"+align+"/"+rang+".gif'  alt=\""+getalign(align)+"\" title=\""+getalign(align)+"\" border='0' /> ";
	if (dealer>0)s+="<img src='http://UFC/img/orden/dealer.gif' border=0 alt=\"Диллер игры\">";

	if (klan) s+="<a href='http://UFC/clan_inf.php?clan="+klan+"' target='_blank'><img src='http://UFC/img/clan/"+klan+".gif'  alt='Ханство "+klanid+"' border='0' /></a>";
	s+="<b>"+name+"</b> ["+level+"] <a href='http://UFC/info.php?log="+name+"' target='_blank'><img src='http://UFC/img/index/h.gif' alt='Инф. о "+name+"' border='0' /></a>";
	document.write(s);
}
function wk(name, id, level, dealer, align, rang, klan, klanid,slp,trv)
{
	...
	var s="";
	if (align>0) s+="<img src='http://UFC/img/orden/"+align+"/"+rang+".gif'  alt=\""+getalign(align)+"\" border='0' /></a> ";
	if (dealer>0)s+="<img src='http://UFC/img/orden/dealer.gif' border=0 alt=\"Диллер игры\">";

	if (klan) s+="<a href='http://UFC/clan_inf.php?clan="+klan+"' target='_blank'><img src='http://UFC/img/clan/"+klan+".gif'  alt='Ханство "+klanid+"' border='0' /></A>";
	s+="<b>"+name+"</b>";
	if (level!=-1) s+=" ["+level+"]";
	if (id!=-1) s+="<a href='http://UFC/info.php?log="+name+"' target='_blank'><img src='http://UFC/img/index/h.gif' alt='Инф. о "+name+"' border='0' /></a>";
	if (slp>timestamp) { s+=' <img src=\"http://UFC/img/index/molch.gif\" alt=\"Наложено заклятие молчания\">'; }
	if (trv>0) { s+=' <img src=\"http://UFC/img/index/travma.gif\" alt=\"Персонаж травмирован\">'; }
	document.write(s);
}
function w(name, id, level, dealer, align, rang, klan, klanid, slp, trv)
{
	var timestamp = requestFile();
	var s="";
	s+="<nobr><a href=\"javascript:top.AddToPrivate('"+name+"')\"><img border='0' src='http://UFC/img/arrow3.gif' alt='Приватное сообщение' ></a> ";
	if (align>0) s+="<img src='http://UFC/img/orden/"+align+"/"+rang+".gif'  alt=\""+getalign(align)+"\" border='0' /></a> ";
	if (dealer>0)s+="<img src='http://UFC/img/orden/dealer.gif' border=0 alt=\"Диллер игры\">";
	...
	if (level!=-1) s+=" ["+level+"]";
	if (id!=-1) s+="<a href='http://UFC/info.php?log="+name+"' target=_blank><img src='http://UFC/img/index/h.gif' alt='Инф. о "+name+timestamp+"' border='0' /></a>";
	if (slp>timestamp) { s+=' <img src=\"http://UFC/img/index/molch.gif\" alt=\"Наложено заклятие молчания\">'; }
	if (trv>0) { s+=' <img src=\"http://UFC/img/index/travma.gif\" alt=\"Персонаж травмирован\">'; }
	s+='</nobr><br>';
	document.write(s);
...
function wks(name, id, level, dealer, align, rang, klan, klanid, slp, trv,slp_time)
{
	...
	if (level!=-1) s+=" ["+level+"]";
	if (id!=-1) s+="<a href='http://UFC/info.php?log="+name+"' target=_blank><img src='http://UFC/img/index/h.gif' alt='Инф. о "+name+"' border='0' /></a>";
	if (slp>slp_time) { s+=' <img src=\"http://UFC/img/index/molch.gif\" alt=\"Наложено заклятие молчания\">'; }
	if (trv>0) { s+=' <img src=\"http://UFC/img/index/travma.gif\" alt=\"Персонаж травмирован\">'; }
	s+='</nobr><br>';
	document.write(s);
}
...
function usr(name, id, level, dealer, align, rang, klan, klanid, slp, trv)
{
	...
	if (level!=-1) s+=" ["+level+"]";
	if (id!=-1) s+="<a href='http://UFC/info.php?log="+name+"' target=_blank><img src='http://UFC/img/index/h.gif' alt='Инф. о "+name+"' border='0' /></a>";
	if (slp>0) { s+=' <img src=\"http://UFC/img/index/molch.gif\" alt=\"Наложено заклятие молчания\">'; }
	if (trv>0) { s+=' <img src=\"http://UFC/img/index/travma.gif\" alt=\"Персонаж травмирован\">'; }
	s+='</nobr><br>';
	document.write(s);
}
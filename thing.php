...
<table width='100%' border='0' cellspacing='0' cellpadding='0'>
  <tr>
    <td width='50%'>&nbsp;Фильтр: <a href='?type=edit&otdel=$otdel'>Все</a> |  <img src='img/artefakt.gif'> <a href='?type=edit&otdel=$otdel&sort=1'>Магазин Артов</a> |  <img src='img/icon/artefakt.gif'> <a href='?type=edit&otdel=$otdel&sort=2'>Артефактный магазин</a></td>
    <td width='50%' align=right><INPUT type=button style='width:15%; cursor:hand' onClick=\"location.href='/main.php?act=no'\" value=\"Вернуться\" class=\"newbut\">&nbsp;</td>
  </tr>
</table>";

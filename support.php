...
<html>
<head>
<link rel="icon" href="main_images/i/favicon.ico" type="image/x-icon">
<link rel="shortcut icon" href="main_images/i/favicon.ico" type="image/x-icon"> 
...
<div class="langSelect">	<ul>	<li>
	...
	<table border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#f8f1d4" width="80%">
		...
		<table border="0" cellpadding="0" cellspacing="0" width=100%>
			<tr bgcolor="#242422">
				<td valign="bottom"><a href="/support.php"><img src="/img/support/logo.gif" width="416" height="140" alt="Support OLD-BK.com" border="0"></a></td>
...
<tr>
	...
	<td colspan=2>
<center><h3>Служба поддержки Бойцовского Клуба<br><span style="color: #ff0000;">[тестовый режим]</span></h3></center>

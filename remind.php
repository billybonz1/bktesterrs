...
<html>
<HEAD>	
	<title>UFC - [Восстановление забытого пароля]</title>
...
<?
	...
	if(!empty($login) && !empty($mymail))
	{
    	...
    	else 
    	{
			...
			$subject="UFC. Пароль для персонажа $login_full";
			
			$message = "<center><b style='color:#ff0000;font-size:15px'>UFC - Отличная RPG онлайн игра посвященная боям и магии. Тысячи жизней, миллионы смертей, два бога, сотни битв между Светом и Тьмой.</b></center><br><br>";
			$message .= "<b>Здраствуйте!</b><br><br>";
			$message .= "Кто-то с ip-адреса <b>$ip</b> запросил пароль к персонажу <b style='color:green;font-size:12px'>$login_full</b> он-лайн игры <a href='http://UFC'><b>UFC</b></a>.<br>";
			...
			$message .= "<div align=right style='color:green;font-weight:bold'>Администрация UFC.</div></font>";
			
			$headers  = 'MIME-Version: 1.0' . "\r\n";
			$headers .= 'Content-type: text/html; charset=windows-1251' . "\r\n";
			$headers .= 'From: UFC <admin@old-bk.com>' . "\r\n";

...
if ($db["orden"]==1 && $db["admin_level"]>8)
{
    ...
    if($db["adminsite"]>2)
    {
		...
		echo "&nbsp; &nbsp; &nbsp; <a href='#' onclick=\"takemoney('Дать Золото персонажу', '?spell=addmoney', 'target', '',4)\" class=us2 title='Дать Золото персонажу.'>::Дать Золото персонажу</a><BR>";
		echo "&nbsp; &nbsp; &nbsp; <a href='#' onclick=\"takemoney('Дать платина персонажу', '?spell=addpl', 'target', '',4)\" class=us2 title='Дать платина персонажу.'>::Дать платина персонажу</a><BR>";
    ...
    if($db["admin_level"]>=10)
    {
		...
		echo "&nbsp; &nbsp; &nbsp; <a href='chat_archive.php'  class=us2 title='Просмотр лог Чата' >::Просмотр лог Чата</a><BR>";
	...
	if($db["adminsite"]>2)
    {
    	...
    	echo "<br><b style='color:red'>Администрация UFC '</b><br>";
		echo "&nbsp; &nbsp; &nbsp; <a href='/add.php'  class=us2 title='Редактирование вещей'>::Редактирование вещей</a><BR>";
		...
		echo "&nbsp; &nbsp; &nbsp; <a href='#' onclick=\"status('Назначить статус', '?spell=84', 'target', '',4)\" class=us2 title='Назначить статус.'>::Назначить статус</a><BR>";
		echo "&nbsp; &nbsp; &nbsp; <a href='?spell=news'  class=us2 title='новости.'>::Добавление Новости!</a><BR><BR>";
	...
	if(!empty($spell))
	{
		switch ($spell)
		{
		case "addmoney":include "magic/1/addmoney.php";break;
		case "addpl":include "magic/1/addpl.php";break;
			...
			case "news":include "magic/1/newsn.php";break;
		}
	}
	echo "</div>";
}

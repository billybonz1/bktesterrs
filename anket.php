...
if ($action=="secure")
{
	...
	if ($_POST['dochpass']) 
	{
		...
		if ($ok) 
		{
            ...
            $message .= "Кто-то с ip-адреса <b>$ip</b> $date был сменен пароль к персонажу $login UFC</b>. <br><br>";
            $message .= "<b>Новый пароль</b>: $newpass<br><br><br><br>";
            $message .= "<b style='color:green'>С уважением. администрация UFC</b>";
			
			$headers  = 'MIME-Version: 1.0' . "\r\n";
			$headers .= 'Content-type: text/html; charset=windows-1251' . "\r\n";
			$headers .= 'From: UFC <admin@UFC' . "\r\n";
	...
	if ($_POST['dochmail']) 
	{
		...
		{	
            ...
            $message = "<b>Здраствуйте, $login!</b><br><br>";
            $message .= "Кто-то с ip-адреса <b>$ip</b> $date был сменен e-mail, указанный при регистрации персонажа <b>$login</b> UFC</b>.<br>";
		...
		<table width="95%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CEBBAA" name="F1">
			...
			<tr class='l1'>
				<td colspan=2>
					...
					</small><br><U>Будьте внимательны!</U> Второй пароль нельзя получить на email или узнать как-либо еще. Если вы его забудете/потеряете, вы не сможете войти в <b>UFC/b> своим персонажем!<BR>
				</td>
			</tr>
			<tr class='l1'>
				<td>
	...
	<b>ПРЕДУПРЕЖДЕНИЕ!!!</b><br>
		...
		&bull; Вводите логин и пароль только на титульной странице <A HREF="" target=_blank>UFC</A> Ни на каких других сайтах, которые будут как две капли похожие на наш, и куда вас зазывают обещая на халяву предметы и кредиты, не вводите свой пароль! Иначе вы рискуете потерять своего персонажа.<br>
	<br><br>
	<? 
	}
}

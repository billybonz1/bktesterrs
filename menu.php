...
<script>
	function new_win(name)
	{
		if(name == 'forum')
		{
			window.open('forum/index.php?'+Math.random(),'forum');
		}
		if(name == 'who')
		{
			window.open('who.php?'+Math.random(),'who');
           }
		if(name == 'lic_nastavnik')
		{
			window.open('lic_nastavnik.php?'+Math.random(),'who');
		...
		<td width=100%>
			...
			<tr>
				<td height=35 valign=bottom align=right>
					...
					<?}?>
					<a href="javascript:url('inv');" title="Инвентарь персонажа">Инвентарь</a> <img src="img/design/menu-ball.gif" width=14 height=14 hspace=1 vspace=0 border=0 style="vertical-align:bottom"> 
...
<a href="javascript:url2('lic_nastavnik.php');" title="Наставничество">Наставник</a> <img src="img/design/menu-ball.gif" width=14 height=14 hspace=1 vspace=0 border=0 style="vertical-align:bottom"> 

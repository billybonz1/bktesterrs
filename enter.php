...
if (getenv('REMOTE_ADDR')!="85.132.96.76")
$times=md5(time());
//-----------------------------------------
			...
			else
			{
			    ...
			    {	
					...
					if ($ok==true)
					{
						...
						#else {Header("Location: http://".$DATA["city_game"].".battles.php?tmp=$times");die();}
					}
			    }
			}
		}
...
<html>
<head>
	<title>UFC - [ Авторизация ]</title>
	<link rel=stylesheet href=\"main.css\" type=\"text/css\">
</head>
<body bgcolor=\"#faeede\">
<b style='color:#ff0000'>".$error."</b><br>
<hr>
<div align=right><a href='http://UFC'>© 2006-".date("Y")." UFC - Самый азартный проект!</a></div>
</body>
</html>";
?>
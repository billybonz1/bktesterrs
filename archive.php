...
<table align="center" width="100%" border="0">
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><img src="/img/z/1.gif"></td>
  </tr>
  <tr>
  ...
  <td width="14%" align="center">
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><img src="/img/z/2.gif"></td>
  </tr>
  <tr>		
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><img src="/img/z/4.gif"></td>
  </tr>
  <tr>
  ...
  <td width="14%" align="center">
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><img src="/img/z/6.gif"></td>
  </tr>
  <tr>
  ...
  <td width="14%" align="center">
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><img src="/img/z/3.gif"></td>
  </tr>
  <tr>
  ...
  <td width="14%" align="center">
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><img src="/img/z/5.gif"></td>
  </tr>
  <tr>
...
if($_POST["type"]!="")
{
	...
	else
	{
		...
		while ($i<mysql_num_rows($TEAM)) 
		{
	        ...
	        echo  "<tr class='".($n?'l0':'l1')."'><td valign=top><b>$i</b>. </td><td nowrap valign=top>".$vaxt."<br><small><b>Тип боя:</b> <u>".boy_type($btype)."</small></td><td width=100%>$team1 $win1 <SPAN style='color: red; font-weight: bold; '>против</SPAN> $team2 $win2 <a href='log.php?log=$bid&tmp=".md5(time())."' class=us2>»»</a></td></tr>";
		}
		echo "</table>";
	}
}
	...
	if (($my_orden == 1 && $adminsite >= 5) || ($my_orden == 6 && $adminsite >= 3))
	{
		...
		while($res=mysql_fetch_array($sql))
		{
			...
			{	
				...
				echo  "<div style='padding: 2px;'> ".$vaxt." $team1 $win1 <i>против</i> $team2 $win2 <a href='log.php?log=$B&tmp=".md5(time())."' class=us2>»»</a></div>";
			}
		}

...
function show(min, max)
{
	...
	s="<table border='0' cellpadding='0' cellspacing='0' width='180' height='10'><tr><td width='100%' nowrap background='img/icon/grey.jpg'><img src='"+color+"'  title='Уровень жизни' height='10' width='"+m2+"%'></td><td><b style='font-weight: bold;font-size: 10; color: #000000'>"+min+"/"+max+"</b></td></tr></table>";
	document.write(s);
}
//
function VesualBot(bots,loc)
{
	...
	{
		cord+=40;
		k+= "<img src='img/novruz/bots/"+bots[i]+".gif' style='POSITION:absolute;LEFT:"+cord+"px;' title='Подземные существа'>";
	}
...
function VesualBot2(bots,loc)
{
	...
	{
		cord+=35;
		k+= "<img src='img/novruz/bots/"+bots[i]+".gif' style='height:100px;POSITION:absolute;LEFT:"+cord+"px;' title='Подземные существа'>";
	}

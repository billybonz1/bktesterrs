...
#if ($DEFEND_DATA["login"]=="Adminion")say($DEFEND_DATA["login"],$DEFEND_DATA["login"]."-".$ATTACK_DATA["login"]."-".voin_type($DEFEND_DATA)."-".voin_type($ATTACK_DATA)."-".$P_HDATA["type"],$DEFEND_DATA);

...
function OpenMenu(id, e)
{
	...
	x = e.clientX + document.documentElement.scrollLeft +document.body.scrollLeft - 5;
	y = e.clientY + document.documentElement.scrollTop + document.body.scrollTop-5;
	if (e.clientY + 72 > document.body.clientHeight) { y-=62 } else { y-=2 }
	e.returnValue=false;

...
<head>
	...
	<meta name="author" content="old-bk.com">
	...
	function s(e)
	{
       	if (document.all && document.all.item && !window.opera && !document.layers)
		{
			//rof IE only
	   		...
	   		var sFeatures = 'dialogLeft:'+x+'px;dialogTop:'+y+'px;dialogHeight:320px;dialogWidth:400px;help:no;status:no;unadorned:yes';
	   		window.showModelessDialog("smiles.php?showie", window, sFeatures);
		} 
		else
		{
			window.open("smiles.php","Smiles","width=600, height=320, left=500,top=500,status=yes,menubar=yes,scrollbars=1");
		}
	}
	function url2(url)
	{

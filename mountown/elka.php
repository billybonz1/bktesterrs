...
else if ((date(n)==12 && date(j)>=1) || (date(n)==1 && date(j)<=10)  || $db["adminsite"]) {$text_type=2;$h3="Новогодняя ёлка";}//New Year
...
if ($_GET['action']=="getbirth")
{
	if (date(n)==8 && (date(j)==4 || date(j)==5 || date(j)==6 || date(j)==7  || date(j)==8 || date(j)==9))
	{
		...
		if (!$findpodarka)
		{
			...
			mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','52','scroll','magic','20','1','Администрации UFC')");#Тактика Крови
			mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','53','scroll','magic','20','1','Администрации UFC')");#Тактика Защиты
			mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','54','scroll','magic','20','1','Администрации UFC')");#Тактика Ответа
			mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','55','scroll','magic','20','1','Администрации UFC')");#Тактика Боя
			mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','258','scroll','magic','20','1','Администрации UFC')");#Тактика Парирования
			...
			mysql_query("INSERT INTO inv(owner,object_id,object_type,object_razdel,gift,wear,gift_author) VALUES('".$login."','34','medal','medal','1','0','Администрации UFC')");#Медал Нам 4 года!
...
{
	if ((date(n)==12 && date(j)>=28) || (date(n)==1 && date(j)<=3) || $db["adminsite"])
	{	
		...
		if (!$findpodarka)
		{
			...
			mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','94','scroll','magic','75','1','Администрации UFC')");#Восстановление энергии 1000HP 
			mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','176','scroll','magic','50','1','Администрации UFC')");#Восстановление маны 1000MN 
			mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','129','scroll','magic','10','1','Администрации UFC')");#Двуручный Зверь
			...
			mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','116','scroll','magic','10','1','Администрации UFC')");#Клонирование
			mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','4','scroll','magic','10','1','Администрации UFC')");#Нападение 
			mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','259','scroll','magic','10','1','Администрации UFC')");#Жажда жизни+6
			
			mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author,term) VALUES ('".$login."','223','scroll','magic','10','1','Администрации UFC','".(time()+30*24*3600)."')");#Зелье Сокрушения[3]
			if ($_GET["type"]=="mag")
			{
				mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author,term) VALUES ('".$login."','229','scroll','magic','5','1','Администрации UFC','".(time()+30*24*3600)."')");#Эликсир злых намерений
				mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author,term) VALUES ('".$login."','233','scroll','magic','5','1','Администрации UFC','".(time()+30*24*3600)."')");#Эликсир Признания
				mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author,term) VALUES ('".$login."','228','scroll','magic','15','1','Администрации UFC','".(time()+30*24*3600)."')");#Ледяной Интеллект
			}
			else
			{
				mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author,term) VALUES ('".$login."','230','scroll','magic','5','1','Администрации UFC','".(time()+30*24*3600)."')");#Эликсир добрых намерений
				mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author,term) VALUES ('".$login."','231','scroll','magic','5','1','Администрации UFC','".(time()+30*24*3600)."')");#Эликсир гиганта
				mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author,term) VALUES ('".$login."','227','scroll','magic','15','1','Администрации UFC','".(time()+30*24*3600)."')");#Сила Великана						
			}
			if ($db["level"]>=8)
			{	
				if ($db["level"]==8)$item_str="(484, 485, 486, 487)";
				else if ($db["level"]==9)$item_str="(531, 530, 529, 528)";
				else if ($db["level"]>=10)$item_str="(534, 535, 536, 533)";
			...
			if ($veteran==1)
			{
				mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','250','scroll','magic','5','1','Администрации UFC')");#Izlomdakilar
				mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','251','scroll','magic','5','1','Администрации UFC')");#Izlomdakilar 
				mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','252','scroll','magic','5','1','Администрации UFC')");#Izlomdakilar 
				mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','253','scroll','magic','5','1','Администрации UFC')");#Izlomdakilar 					
				mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','254','scroll','magic','5','1','Администрации UFC')");#Izlomdakilar 
				mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','255','scroll','magic','5','1','Администрации UFC')");#Izlomdakilar 					
				mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','256','scroll','magic','5','1','Администрации UFC')");#Izlomdakilar 
				mysql_query("INSERT INTO inv(owner, object_id, object_type, object_razdel, iznos_max, gift, gift_author) VALUES ('".$login."','257','scroll','magic','5','1','Администрации UFC')");#Izlomdakilar
			}
			
			$vaxt=time()+365*24*60*60;
			mysql_query("INSERT INTO elkapodarka (login,type) VALUES ('".$login."','2')");
			$msg="С наступающим новым 2012 Годом!";
		}
...
<tr>
	...
	<td align=right nowrap>
		...
		<?
			if ((date(n)==12 && date(j)>=1) || (date(n)==1 && date(j)<=3) || $db["adminsite"])
...
<tr>
	...
	<?
		...
		{
			echo "
				<img src='img/upakovka/warrior.gif' onmouseover=\"slot_view('<b>Подарок Для Воина!</b>');\" onmouseout=\"slot_hide();\" style='cursor:hand;' onclick=\"location.href='?action=getbirth&type=warrior'\"> 
				<img src='img/upakovka/mag.gif' 	onmouseover=\"slot_view('<b>Подарок Для Мага!</b>');\" onmouseout=\"slot_hide();\" style='cursor:hand;' onclick=\"location.href='?action=getbirth&type=mag'\">";
		}
		//----------------------------------Ney Year-------------------------------------------------------------------
		if ((date(n)==12 && date(j)>=20) || (date(n)==1 && date(j)<=3) || $db["adminsite"])
		{
			echo "<b>По-традиции, в Новый Год Дед Мороз под ёлку кладет подарки. Так возьмите же свой подарок :) </b></br>
			<img src='img/upakovka/warrior.gif' onmouseover=\"slot_view('<b>Подарок Для Воина!</b>');\" onmouseout=\"slot_hide();\" style='cursor:hand;' onclick=\"location.href='?action=getpodarka&type=warrior'\"> 
			<img src='img/upakovka/mag.gif' 	onmouseover=\"slot_view('<b>Подарок Для Мага!</b>');\" onmouseout=\"slot_hide();\" style='cursor:hand;' onclick=\"location.href='?action=getpodarka&type=mag'\">";
		}
		echo "</center>";
		//----------------------------------Text-------------------------------------------------------------------
